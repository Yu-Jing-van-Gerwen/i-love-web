<div class="week2 generalStyling">
    ...
    <p> <strong>
        ...
        <p>
    Nicolas Garnier is een onafhankelijk creatief developer die zich sinds 2012 focust op webontwikkeling met JavaScript, nadat Flash is verdwenen. Hij begon in 2018 met freelancen en werkte voor bureaus, productbedrijven en startups.
</p>
    <ul>
        <li>
            Hij bouwt websites, apps, installaties en gebruikt daarbij diverse tools zoals JavaScript, CSS, WebGL en Unity.
        </li>
        <li>
    ...
    <ul>
        ...
        <li>
            <a href="https://liefamsterdam.nl/?source=g&device=c&campaignid=19018830878&adgroupid=146600582609&gad_source=1&gclid=Cj0KCQjwpP63BhDYARIsAOQkATYHVHjmpGeKus1q2v-QlQYpIftkppEbL8rp8rYWeYNedtGwc4aqO30aAvkrEALw_wcB">lief amsterdam
            </a>
        </li>
        <li>
