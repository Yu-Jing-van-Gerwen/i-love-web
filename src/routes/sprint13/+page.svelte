<section class="learning questions">


    <h1 id="mijn-leervragen">mijn leervragen</h1>
    <ul>
        <li>Ik wil beter worden in figma en designen hoe je zo&#39;n ontwerp mooi kan maken</li>
        <li>

            3.4.2 Schetst om gedachten en processen te verkennen, abstracte begrippen over te brengen en de
            oplossingsrichting
    ...
    <ul>
        <li>Ik wil beter worden in plannen waardoor mijn wiki en project gestructureerd is</li>
        <li>4.1.1 Richt projecten efficiënt en effectief in volgens de development-lifecycle en houdt rekening met de
            beschikbare tijd.
        </li>

    </ul>
    <ul>
        <li>Ik wil svelte leren kennen en weten hoe ik dit kan gebruiken</li>
        <li>
...
<section>
    ...
    <h2>andere vragen</h2>
    <ul>
        <li>Hoe haal je data uit een Headless CMS door middel van een framework te renderen in een website?</li>
        <li>hoe lever je bewijslast goed in</li>
        <li>hoe zorg ik dat mijn repository overzicheljk en goed navolgbaar is zonder wiki</li>
    </ul>
</section>
...
<section>
    <h2>leerlogboek</h2>
    <ul>
        <li>ga naar <a href="#week1">week1</a> </li>
    ...
    <p>Ik heb mijn 1ste les dag gehad en daarin heb ik svelte geinstalleerd en een ontwerp gemaakt van de squadpage en
    ...
    <p>3-9
        ...
        ik heb gekeken naar hoe ik mijn project kan deployen op vercel en dat is gleukt dankzij deze link <a
                href="https://vercel.com/docs/frameworks/sveltekit">https://vercel.com/docs/frameworks/sveltekit</a></p>
    ...
    <p>dit gaat over sveltekit
        ...
        Code Splitting: Code wordt slim verdeeld over client en server, waardoor de initiële laadtijd van je applicatie
        wordt verminderd.
        Hydration: SvelteKit kan server-rendered HTML &quot;hydrateren&quot; om een volledig interactieve client-side
        applicatie te creëren.
        SSR Only Mode: Je kunt je applicatie volledig server-side renderen, wat ideaal is voor SEO en voor gebruikers
        met
...
<section class="week2">
    ...
    verder hebben we het ook gehad over componeneten en de basisstof van figma zoals auto layout en compononetnen hoe je
    ...
    en ik heb vandaag geleerd hoe ik de connectie met de database maak en iedereen kan laten zien en als je klikt op 1
    ...
    <a href="https://github.com/KaanKalmi/your-tribe-for-life-squad-page/tree/squadpage2.2-yujing">zie de link</a> zie
    de link
    </p>
    <p>
    ...
    <a href="https://codepen.io/twhite96/embed/brryVq?height=600&default-tab=result&embed-version=2#result-box">link hover effecr</a>
    </p>
    ...
    <a href="https://codepen.io/hubspot/embed/ExWxByR?height=384.6151123046875&theme-id=39533&default-tab=css%2Cresult&slug-hash=ExWxByR&editable=true&user=hubspot&name=cp_embed_2#result-box">link code pen</a>
    ...
    <p>
        13-9 hebben we een we love web gehad een gastspreker die ging vertellen over zijn werk en hoe belangrijk toegankelijkheid is

        Vasilis van Gemert is een principal frontender en vakdocent CMD. Zijn LinkedIn-profiel vind je hier.
        Vroeger was hij een kunstenaar. Het nut van onzin maken is dat je er inspiratie uit kunt halen. Voorbeelden hiervan staan op zijn website vasilis.nl.
        ...
        Maak een website niet alleen toegankelijk in theorie, maar ook in de praktijk, zodat deze echt bruikbaar is en je niet achteraf problemen ontdekt.
        Screenreaders kunnen ingewikkeld zijn als je ze nog niet kent. Een gebruiker hoort bijvoorbeeld “heading 2”, wat verwarrend kan zijn.
    ...
    <h4>dit heb ik geleerd</h4>
    <p>
        ik heb een workshop over Figma gevolgd. Tijdens deze workshop hebben we eenvoudige oefeningen gedaan die we moesten namaken. We hebben ook geleerd over componenten en de basisprincipes van Figma, zoals auto layout en hoe je kleuren en buttons kunt hergebruiken. In de les heb ik geprobeerd om een kaartje na te maken met behulp van een grid en geleerd hoe je dit kunt positioneren.
